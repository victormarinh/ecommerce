...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="../src/admin/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../src/admin/index2.html"><b>Admin</b>LTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <a href="../src/admin/register.html" class="text-center">Register a new membership</a>
...
<!-- iCheck -->
<script src="../src/admin/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({

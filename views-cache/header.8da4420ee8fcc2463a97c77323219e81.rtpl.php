...
<html lang="pt-br">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="../src/site/css/bootstrap.min.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="../src/site/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="../src/site/css/owl.carousel.css">
    <link rel="stylesheet" href="../src/site/css/style.css">
    <link rel="stylesheet" href="../src/site/css/responsive.css">
